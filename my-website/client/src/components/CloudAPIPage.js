...
function CloudAPIPage({ enableScrollHandling = true }) {
  ...
  const handleSearchSubmit = async (e, selectedFile = null) => {
    ...
    // Inside CloudAPIPage component
  const handleVideoError = (e) => {
    console.error('Video loading error:', e);
    // Provide more meaningful feedback here
  };
  ...
  return (
    <div className={styles['full-screen-container']}>
      ...
      <video
        ...
        crossOrigin="anonymous" // Adding crossorigin attribute
        onError={(e) => {
          console.error('Video loading error:', e);
          console.error('Error details:', e.nativeEvent); // Log the native event for more details
        }}
      >
