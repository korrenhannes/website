...
const ContentSection = ({ windowWidth, isMobile }) => (
  <div className="content-section">
    ...
    <p className="content-description"><span className="highlight">Our</span> cutting-edge algorithm transforms your favorite podcasts and videos into captivating content for your audience – all with just a simple click.</p>
