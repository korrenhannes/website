  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        <h1 style="color: #1E90FF; text-align: center;">Welcome to ClipIt!</h1>
        <img src=".../client/src/Untitled.png" alt="ClipIt Logo" style="display: block; margin: 20px auto; width: 50%;">
        <p>Hi there!</p>
        ...
        <a href="${confirmationUrl}" style="background-color: #1E90FF; color: white; padding: 15px 25px; text-align: center; text-decoration: none; display: block; margin: 20px auto; width: fit-content; border-radius: 5px; font-weight: bold;">Activate Account</a>
